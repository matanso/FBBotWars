...
public class Reinforcement implements org.apache.thrift.TBase<Reinforcement, Reinforcement._Fields>, java.io.Serializable, Cloneable, Comparable<Reinforcement> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Reinforcement");
  ...
  static {
    schemes.put(StandardScheme.class, new ReinforcementStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReinforcementTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Reinforcement.class, metaDataMap);
  }
   ...
   * X coordinate of square to reinforce
   */
  public Reinforcement setX(int x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
   ...
   * Y coordinate of square to reinforce
   */
  public Reinforcement setY(int y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
   ...
   * Number of units to drop in square
   */
  public Reinforcement setArmySize(int armySize) {
    this.armySize = armySize;
    setArmySizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Reinforcement)
      return this.equals((Reinforcement)that);
    return false;
  }

  public boolean equals(Reinforcement that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(Reinforcement other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Reinforcement(");
    boolean first = true;
  ...
  private static class ReinforcementStandardSchemeFactory implements SchemeFactory {
    public ReinforcementStandardScheme getScheme() {
      return new ReinforcementStandardScheme();
    }
  }

  private static class ReinforcementStandardScheme extends StandardScheme<Reinforcement> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Reinforcement struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Reinforcement struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ReinforcementTupleSchemeFactory implements SchemeFactory {
    public ReinforcementTupleScheme getScheme() {
      return new ReinforcementTupleScheme();
    }
  }

  private static class ReinforcementTupleScheme extends TupleScheme<Reinforcement> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Reinforcement struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Reinforcement struct) throws org.apache.thrift.TException {
